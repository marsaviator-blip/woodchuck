...
var script2 = {
  ...
  methods: {
    ...
    initializePanels: function initializePanels() {
      ...
      if (this.panels && this.panels.length) {
        ...
        if (!initialized) {
          var children = _toConsumableArray2(this.$el.children).filter(function(child) {
    ...
    onResizeStart: function onResizeStart(event, index, isKeyDown) {
      ...
      if (isKeyDown) {
        this.prevPanelSize = this.horizontal ? v(this.prevPanelElement, true) : C2(this.prevPanelElement, true);
        this.nextPanelSize = this.horizontal ? v(this.nextPanelElement, true) : C2(this.nextPanelElement, true);
      } else {
        this.prevPanelSize = 100 * (this.horizontal ? v(this.prevPanelElement, true) : C2(this.prevPanelElement, true)) / this.size;
        this.nextPanelSize = 100 * (this.horizontal ? v(this.nextPanelElement, true) : C2(this.nextPanelElement, true)) / this.size;
      }
  ...
  computed: {
    ...
    dataP: function dataP() {
      ...
      return f(_defineProperty2(_defineProperty2({}, this.layout, this.layout), "nested", ((_this$$parentInstance2 = this.$parentInstance) === null || _this$$parentInstance2 === void 0 ? void 0 : _this$$parentInstance2.nestedState) != null));
    }
  }
};
