...
public class ParentWorkflowServiceImpl implements ParentWorkflow{
     ...
     public void startBioWorkflow() {
        ...
        // System.out.print("ParentWorkflowServiceImpl starting BioWorkflow with request: " + bioRequest);
        // bioWorkflow.execute(bioRequest);
     }

     public void startMPWorkflow() {
...
//        mpSpec.setParameter("example parameter");
        ...
        System.out.print("ParentWorkflowServiceImpl starting MPWorkflow with spec: " + mpSpec);
        mpWorkflow.processMP(mpSpec);
     }
}